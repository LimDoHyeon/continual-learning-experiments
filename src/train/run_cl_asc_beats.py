...
def _build_system(cfg: Dict[str, Any], num_classes: int, init_ckpt: Optional[Path]) -> ASCBEATsSystem:
    if init_ckpt is None:
        return ASCBEATsSystem(cfg=cfg, num_classes=num_classes)
    return ASCBEATsSystem.load_from_checkpoint(
